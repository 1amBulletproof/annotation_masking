# -*- encoding: utf-8 -*-
#Author: https://github.com/mypetyak/StrokeWidthTransform
#Since: 2017
...
class SWTScrubber(object):
    ...
    def _swt(self, theta, edges, sobelx64f, sobely64f):
        ...
        print mag_g
        #THERE IS A DIVIDE BY 0 OR NAN HERE WHICH KILSL STUFF
...
try:
    ...
    final_mask = SWTScrubber.scrub('annotation_img.png')
